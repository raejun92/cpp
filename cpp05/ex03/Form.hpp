...
class Form {
	public:
		...
		class SignFalseException : public std::runtime_error {
			public:
				SignFalseException(std::string message="It wasn't signed") : std::runtime_error(message) {}
		};
		class OutputStreamException : public std::runtime_error {
			public:
				OutputStreamException(std::string message="File not work") : std::runtime_error(message) {}
		};
